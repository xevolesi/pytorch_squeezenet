...
def _assert_output(model_output, true_batch_size, true_output_channels, true_height, true_width):
...
def test_expand_layer(get_test_config, in_channels, out_channels_1x1, out_channels_3x3):
...
def test_fire_module(get_test_config, in_channels, squeeze_channels, out_channels):
